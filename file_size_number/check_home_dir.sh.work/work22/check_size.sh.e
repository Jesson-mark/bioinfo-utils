hostname
+ hostname
cd /public/home/fan_lab/wangjie/utils/file_size_number/check_home_dir.sh.work/work22
+ cd /public/home/fan_lab/wangjie/utils/file_size_number/check_home_dir.sh.work/work22
starttime=$(date +'%Y-%m-%d %H:%M:%S')
++ date '+%Y-%m-%d %H:%M:%S'
+ starttime='2023-06-24 11:11:55'

time du -sh /public/home/fan_lab/wangjie/stdin.split
+ du -sh /public/home/fan_lab/wangjie/stdin.split

real	0m0.004s
user	0m0.000s
sys	0m0.004s
touch /public/home/fan_lab/wangjie/utils/file_size_number/check_home_dir.sh.work/work22/check_size.sh.done
+ touch /public/home/fan_lab/wangjie/utils/file_size_number/check_home_dir.sh.work/work22/check_size.sh.done
